...
export interface backendInterface {
    addInventoryStock(plant: string, productName: string, quantity: bigint, user: string): Promise<boolean>;
    ...
    removeInventoryStock(plant: string, productName: string, quantity: bigint, user: string): Promise<boolean>;
