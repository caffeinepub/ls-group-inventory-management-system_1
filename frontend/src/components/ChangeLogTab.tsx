    ...
    <Card className="border border-border shadow-sm">
      <CardHeader className="pb-3 border-b border-border bg-muted/30">
        <CardTitle className="flex items-center gap-2 text-base font-bold">
          ...
          Change Log
          <span className="ml-2 text-xs font-normal text-muted-foreground">(Last 3 days · Read-only)</span>
        </CardTitle>
      </CardHeader>
              ...
              <table className="w-full text-sm">
                <thead className="sticky top-0 z-10">
                  <tr className="bg-muted/80 border-b border-border backdrop-blur-sm">
                    ...
                    <th className="text-left px-4 py-2.5 font-semibold text-foreground">Plant</th>
                    ...
                    <th className="text-left px-4 py-2.5 font-semibold text-foreground w-28">User</th>
                  </tr>
                </thead>
                <tbody>
                  {sortedLogs.length > 0 ? (
