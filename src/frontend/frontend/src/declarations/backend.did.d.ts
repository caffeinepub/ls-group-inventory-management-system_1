...
export interface _SERVICE {
  getAllData: ActorMethod<[], [string, string, string, string, string, string, string, string, string, string, string]>;
  ...
  getChangeLogOrders: ActorMethod<[], string>;
  setChangeLogOrders: ActorMethod<[string], undefined>;
}
